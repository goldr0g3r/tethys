...
This module implements the minimal subset of XCP 1.4 Part 2 needed by the
Phase 1 hello-world acceptance bench: CONNECT, DISCONNECT, GET_VERSION,
GET_STATUS, plus the corresponding response frame parsing.

Phase 2 (parent plan §8) extends this to the full Standard Command set
(SET_MTA, UPLOAD, SHORT_UPLOAD, DOWNLOAD, BUILD_CHECKSUM, SYNCH).
...
Trace: docs/traceability.csv row TETHYS-DES-0001..0004 (lands at PR-10)
"""
...
class XcpCommand(IntEnum):
    """XCP Standard Command codes (subset for Phase 1).
...
class XcpError(IntEnum):
    """XCP error codes (XCP 1.4 Part 2 Table 12; subset)."""
