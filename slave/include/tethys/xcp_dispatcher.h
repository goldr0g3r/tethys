/*
 * tethys/xcp_dispatcher.h - XCP command dispatcher for the Phase 1 subset.
 *
 * Module: tethys::core::xcp_dispatcher
 * Profiles: all (marine, space, posix-sim)
 * Standards: ASAM XCP 1.4 Part 2 §1.3.2 + §1.4.2.1; MISRA C:2023; ECSS-E-ST-40C Rev.1 §5.4
 ...
 *   - SET_MTA / UPLOAD / DOWNLOAD / BUILD_CHECKSUM (Phase 2)
